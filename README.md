...
The conversions were made with extensive use of Github Copilot coding agent. As well as contributing towards the preservation of BCPL, it demonstrates that coding agents can do far more than frontend and boilerplate. In fact, this is en effect low-level programming, involving virtual machines.
